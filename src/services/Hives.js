/*
 *  Document   : Hives.js based on Codebase.js by Pixelcave
 *  Author     : Jean Barriere
 *  Description: Hives Custom Functionalities
 *
 */
...
export class Hives {
  ...
  static uiInit () {
    ...
    this.lPage = document.querySelector('#hives')
